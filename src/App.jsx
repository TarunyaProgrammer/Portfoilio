...
const Nav = () => (
  <nav className="fixed top-0 left-0 right-0 z-50 p-6 flex justify-between items-center mix-blend-difference pointer-events-none">
    ...
    <div className="hidden md:flex gap-8 font-mono text-sm text-gray-300 pointer-events-auto">
      ...
      <Link
        to="/connect"
        className="text-neon border border-neon px-4 py-2 rounded-full hover:bg-neon hover:text-black transition-all"
      >
        CONNECT
      </Link>
    </div>
