      ...
      <div className="container mx-auto px-8 md:px-16">
        <div className="flex flex-col md:flex-row justify-between items-end mb-32 gap-12">
          <div className="max-w-2xl">
            ...
            <h2 className="text-5xl md:text-8xl font-bold text-black tracking-tighter leading-[0.85]">
              Surgical <br />
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12">
          {engageOptions.map((option, index) => (
            <motion.div
              ...
              className="group p-12 border border-black/5 bg-white hover:border-black transition-all duration-500 shadow-sm hover:shadow-[0_40px_80px_-30px_rgba(0,0,0,0.1)] relative"
            >
              ...
              <div className="text-[10px] font-bold text-black/20 uppercase tracking-[0.4em] mb-8 group-hover:text-black transition-colors">
                0{index + 1} // {option.id}
              </div>
              <h3 className="text-3xl font-bold text-black mb-6 group-hover:italic transition-all">
                {option.title}
              </h3>
